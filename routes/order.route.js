...
router.get('/user/:userRef', order_controller.all_orders_by_client);
...
router.get('/:orderRef/best-manufacture', order_controller.get_best_manufacture);
router.put('/:orderRef/manufacture', order_controller.add_manufacture);
